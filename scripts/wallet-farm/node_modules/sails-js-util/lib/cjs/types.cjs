...
var payloadMethod = require('./payload-method.cjs');

const getJsTypeDef = (typeDef, payloadMethod$1) => {
    if (typeDef.isPrimitive) {
        if (payloadMethod$1 === payloadMethod.PayloadMethod.toNumber) {
            return { type: 'number', imports: [] };
        }
        if (payloadMethod$1 === payloadMethod.PayloadMethod.toBigInt) {
...
exports.getJsTypeDef = getJsTypeDef;
