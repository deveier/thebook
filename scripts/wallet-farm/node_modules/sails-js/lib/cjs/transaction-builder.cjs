...
class TransactionBuilder {
    ...
    constructor(_api, _registry, extrinsic, _service, _method, payload, payloadType, _responseType, _programIdOrCodeOrCodeId, _onProgramCreated) {
        ...
        const _payload = util.u8aConcat(encodedService, encodedMethod, data);
    ...
    decodePayload(payload) {
        const method = payloadMethod.getPayloadMethod(this._responseType);
    ...
    throwOnErrorReply({ payload, details }) {
        utils.throwOnErrorReply(details.unwrap().code, payload, this._api.specVersion, this._registry);
    }
    /**
